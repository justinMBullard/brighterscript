...
function createClassMethodStatement(name, kind = TokenKind_1.TokenKind.Function, accessModifier) {
    return new Statement_1.ClassMethodStatement(accessModifier, createIdentifier(name), createFunctionExpression(kind), null);
}
