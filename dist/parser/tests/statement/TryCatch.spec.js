...
describe('parser try/catch', () => {
    it('can parse try catch statements', () => {
        ...
        (0, chai_1.expect)((_b = stmt.tokens.try) === null || _b === void 0 ? void 0 : _b.text).to.eql('try');
        (0, chai_1.expect)(stmt.tryBranch).to.exist.and.ownProperty('statements').to.be.lengthOf(1);
        (0, chai_1.expect)(stmt.catchStatement).to.exist;
        const cstmt = stmt.catchStatement;
        (0, chai_1.expect)((_c = cstmt.tokens.catch) === null || _c === void 0 ? void 0 : _c.text).to.eql('catch');
        (0, chai_1.expect)(cstmt.exceptionVariable.text).to.eql('e');
        (0, chai_1.expect)(cstmt.catchBranch).to.exist.and.ownProperty('statements').to.be.lengthOf(1);
        (0, chai_1.expect)((_d = stmt.tokens.endTry) === null || _d === void 0 ? void 0 : _d.text).to.eql('end try');
    });
