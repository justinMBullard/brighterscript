...
describe('manifest support', () => {
    ...
    describe('manifest parser', () => {
        it('returns an empty map if manifest not found', async () => {
            ...
            return (0, chai_1.expect)(await (0, Manifest_1.getManifest)('/no/manifest/here')).to.eql(new Map());
        });
        ...
        it('ignores comments', () => {
            return (0, chai_1.expect)((0, Manifest_1.parseManifest)('')).to.eql(new Map());
        });
        it('retains whitespace for keys and values', () => {
            (0, chai_1.expect)((0, testHelpers_spec_1.mapToObject)((0, Manifest_1.parseManifest)(' leading interum and trailing key spaces = value '))).to.eql({
                ' leading interum and trailing key spaces ': ' value '
            });
        });
        it('does not convert values to primitives', () => {
            (0, chai_1.expect)((0, testHelpers_spec_1.mapToObject)((0, Manifest_1.parseManifest)((0, testHelpers_spec_1.trim) `
                        name=bob
                        age=12
                        enabled=true
                        height=1.5
    ...
    describe('bs_const parser', () => {
        function test(manifest, expected) {
            (0, chai_1.expect)((0, Manifest_1.getBsConst)((0, Manifest_1.parseManifest)(manifest))).to.eql((0, testHelpers_spec_1.objectToMap)(expected));
        }
        ...
        it('trims whitespace from keys and values', () => {
            ...
            (0, chai_1.expect)((0, Manifest_1.getBsConst)(manifest)).to.eql(new Map([['key', true]]));
        });
        ...
        it('allows case-insensitive booleans', () => {
            ...
            (0, chai_1.expect)((0, Manifest_1.getBsConst)(manifest)).to.eql(new Map([
                ['foo', true],
                ['bar', false]
            ]));
        });
